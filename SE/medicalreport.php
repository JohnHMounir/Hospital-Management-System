...
<html>
  ...
  <body>
    ...
    <form  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" id="medicalreport">
      ...
      <OPTION id="y23" Value="2023">2023</OPTION>
       ...
       <br> <textarea name="Medicalreport" rows="30" cols="90" form="medicalreport" value="">On making a medical examination on Mr.</textarea>  <br>
