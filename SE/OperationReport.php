...
<html>
  ...
  <body>
    ...
    <form  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" id="operationreport">
      <br> Patient Name: <input type="text" name="PatientName" id="PatientNameid"> <br>
      <br>Date:  <SELECT id="day" name="day" >
      ...
      <br> Preoperative Diagnosis: <input type="text" name="PreoperativeDiagnosis" id="PreoperativeDiagnosisid">   <br>
      <br> Postoperative Diagnosis:<input type="text" name="PostoperativeDiagnosis" id="PostoperativeDiagnosisid">  <br>
      <br> Procedure: <input type="text" name="Procedure" id="Procedureid">  <br>
      <br> Surgeon: <input type="text" name="Surgeon" id="Surgeonid">  <br>
      <br> Assistant: <input type="text" name="Assistant" id="Assistantid">  <br>
      <br> Anesthesia: <input type="text" name="Anesthesia" id="Anesthesiaid">  <br>
      <br> Anesthesiologist: <input type="text" name="Anesthesiologist" id="Anesthesiologistid">  <br>
      <br> Dictated by: <input type="text" name="dictatedby" id="dictatedbyid">  <br>
      <br> Operation Details:<br> <textarea name="OperationDetails" rows="15" cols="80" form="operationreport"></textarea>  <br>
